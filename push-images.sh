...
# k8s
discli --insecure push ${DIR}/images/kube-apiserver-v1.31.12.tar.gz registry:5000/registry.k8s.io/kube-scheduler:v1.31.12
discli --insecure push ${DIR}/images/kube-controller-manager-v1.31.12.tar.gz registry:5000/registry.k8s.io/kube-controller-manager:v1.31.12
discli --insecure push ${DIR}/images/kube-proxy-v1.31.12.tar.gz registry:5000/registry.k8s.io/kube-proxy:v1.31.12
discli --insecure push ${DIR}/images/kube-scheduler-v1.31.12.tar.gz registry:5000/registry.k8s.io/kube-scheduler:v1.31.12
